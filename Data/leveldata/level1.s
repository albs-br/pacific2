...
.levelDataStart:
    ...
    db  128, TOP_SCREEN_IN_PIXELS+16  ; enemy position (x, y)
    db  4                   ; enemy number
    db  0                   ; reserved
...
;------ 4 planes from left/right, one/two per turn, no shooting
    ...
    db  0, TOP_SCREEN_IN_PIXELS + 32  ; enemy position (x, y)
    db  0                   ; enemy number
    db  0                   ; reserved
    db  0, 0, 0, 0, 0, 0    ; reserved
...
;------ 3 planes from top, one per turn, no shooting
    ...
    db  0                   ; enemy type
    db  15, 14              ; enemy 1st, 2nd color
    db  128-8, TOP_SCREEN_IN_PIXELS   ; enemy position (x, y)
    db  0                   ; enemy number
    db  0                   ; reserved
    db  0, 0, 0, 0, 0, 0    ; reserved
    ...
    db  0                   ; enemy type
    db  9, 6                ; enemy 1st, 2nd color
    db  16, TOP_SCREEN_IN_PIXELS      ; enemy position (x, y)
    db  0                   ; enemy number
    db  0                   ; reserved
    db  0, 0, 0, 0, 0, 0    ; reserved
    ...
    db  0                   ; enemy type
    db  7, 5                ; enemy 1st, 2nd color
    db  256-32, TOP_SCREEN_IN_PIXELS  ; enemy position (x, y)
    db  0                   ; enemy number
    db  0                   ; reserved
    db  0, 0, 0, 0, 0, 0    ; reserved
...
;------ 10 planes from left/right, five per turn, no shooting
    ...
    db  1                           ; enemy type
    db  9, 6                        ; enemy 1st, 2nd color
    db  255, TOP_SCREEN_IN_PIXELS + 16 + 24   ; enemy position (x, y)
    db  1                           ; enemy number
    db  0                           ; reserved
    db  0, 0, 0, 0, 0, 0            ; reserved
    ...
    db  1                           ; enemy type
    db  9, 6                        ; enemy 1st, 2nd color
    db  255, TOP_SCREEN_IN_PIXELS + 16 + 48   ; enemy position (x, y)
    db  2                           ; enemy number
    db  0                           ; reserved
    db  0, 0, 0, 0, 0, 0            ; reserved
    ...
    db  1                           ; enemy type
    db  9, 6                        ; enemy 1st, 2nd color
    db  255, TOP_SCREEN_IN_PIXELS + 16 + 72   ; enemy position (x, y)
    db  3                           ; enemy number
    db  0                           ; reserved
    db  0, 0, 0, 0, 0, 0            ; reserved
    ...
    db  1                           ; enemy type
    db  9, 6                        ; enemy 1st, 2nd color
    db  255, TOP_SCREEN_IN_PIXELS + 16 + 96   ; enemy position (x, y)
    db  4                           ; enemy number
    db  0                           ; reserved
    db  0, 0, 0, 0, 0, 0            ; reserved
    ...
    db  2                           ; enemy type
    db  3, 12                       ; enemy 1st, 2nd color
    db  0, TOP_SCREEN_IN_PIXELS + 16 + 48     ; enemy position (x, y)
    db  2                           ; enemy number
    db  0                           ; reserved
    db  0, 0, 0, 0, 0, 0            ; reserved
    ...
    db  2                           ; enemy type
    db  3, 12                       ; enemy 1st, 2nd color
    db  0, TOP_SCREEN_IN_PIXELS + 16 + 72     ; enemy position (x, y)
    db  3                           ; enemy number
    db  0                           ; reserved
    db  0, 0, 0, 0, 0, 0            ; reserved
    ...
    db  2                           ; enemy type
    db  3, 12                       ; enemy 1st, 2nd color
    db  0, TOP_SCREEN_IN_PIXELS + 16 + 96     ; enemy position (x, y)
    db  4                           ; enemy number
    db  0                           ; reserved
    db  0, 0, 0, 0, 0, 0            ; reserved
...
;------ planes from left/right, one/many per turn, shooting
    ...
    db  2                           ; enemy type
    db  7, 5                        ; enemy 1st, 2nd color
    db  0, TOP_SCREEN_IN_PIXELS + 32 + 24     ; enemy position (x, y)
    db  1                           ; enemy number
    db  0                           ; reserved
    db  0, 0, 0, 0, 0, 0            ; reserved
...
;------ planes from top, one per turn, shooting
    ...
    db  0                           ; enemy type
    db  3, 12                       ; enemy 1st, 2nd color
    db  80, TOP_SCREEN_IN_PIXELS              ; enemy position (x, y)
    db  0                           ; enemy number
    db  0                           ; reserved
    db  0, 0, 0, 0, 0, 0            ; reserved
